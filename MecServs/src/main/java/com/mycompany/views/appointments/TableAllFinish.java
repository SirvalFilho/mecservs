 ...
 * @author Sirval
 */
public class TableAllFinish extends javax.swing.JPanel {

    AgendamentoDaoImpl agendamentos = new AgendamentoDaoImpl();
     
    public TableAllFinish() {
        initComponents();
        initStyles();
        loadFinish();
    }
    ...
    private void initComponents() {
        ...
        tableContent.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Veiculo", "Serviço", "DataAgendamento", "DataDeEntrega", "Status"
            }
        ) {
    ...
    private void loadFinish() {
        ...
        try {
            List<Agendamento> agendamento = this.agendamentos.listarTodosFinalizados();
