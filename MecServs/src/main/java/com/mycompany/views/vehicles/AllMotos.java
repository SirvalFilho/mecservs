 ...
 * @author Sirval
 */
public class AllMotos extends javax.swing.JPanel {

    /**
     * Creates new form AllMotos
     */
    public AllMotos() {
        initComponents();
        initStyles();
    ...
    // Aplica o alinhamento nas colunas
     ...
     public void loadMotos(){
        try{
              ...
              MotoDaoImpl.motosDisponiveis.forEach((u)->model.addRow(new Object[]{u.getPlaca(),u.getModelo(),u.getAnoFabric(),u.getCilindradas(),u.getTipoFreio(),u.getTipoPartida()}));
          }catch(Exception e){
    ...
    private void initComponents() {
        ...
        tableContent.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Placa", "Modelo", "AnoFabric", "Cilindradas", "TipoFreio", "TipoPartida"
            }
        ) {
